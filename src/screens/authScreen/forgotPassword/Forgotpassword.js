  ...
  return (
    <View style={forgotPasswordStyle.registerMain}>
      ...
      <View style={forgotPasswordStyle.textArea}>
        <Text style={forgotPasswordStyle.registerTaintext}>Forgot Password</Text>
        <View style={forgotPasswordStyle.inputHolder}>
          <TextInput style={forgotPasswordStyle.textInput} placeholder="Mobile No." />
          <TextInput style={forgotPasswordStyle.textInput} placeholder="Password" />
          <TextInput
